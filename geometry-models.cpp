...
int main(int argc, char ** argv)
{
  ...
  const std::string model_path = "/home/twilight/project/Dynamics/models/example-robot-data/robots";
  const std::string mesh_dir = "/home/twilight/project/Dynamics/models/example-robot-data/robots";
  const std::string urdf_filename = "/home/twilight/project/Dynamics/models/example-robot-data/robots/ur_description/urdf/ur5_robot.urdf";
